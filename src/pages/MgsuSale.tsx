...
const mistakes = [
  { icon: XCircle, text: "Подали оригинал не в тот вуз — потеряли бюджет" },
  { icon: Clock, text: "Пропустили дедлайн согласия на зачисление" },
  { icon: ShieldAlert, text: "Не знали про целевое — упустили лёгкий путь" },
  { icon: AlertTriangle, text: "Выбрали «модное» направление с бешеным конкурсом" },
];

const MgsuSale = () => {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      {/* BLOCK 1: Hero — Urgency + Pain */}
      <section
      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto text-center text-primary-foreground">
          ...
          >
            ...
            90% абитуриентов совершают эти ошибки
          </motion.div>
          ...
          >
            Ты уверен, что поступишь в&nbsp;МГСУ?
          </motion.h1>
          ...
          >
            Студент с <span className="font-extrabold text-white">290 баллами ЕГЭ</span>, выбиравший между ВШЭ, 
            Финансовой академией и МГСУ, покажет тебе{" "}
            <span className="underline decoration-red-300 decoration-2 underline-offset-4">
              все ловушки приёмной кампании
            </span>{" "}
          ...
          >
            <span className="flex items-center gap-1.5">
              <Zap className="w-4 h-4 text-yellow-300" /> 50+ поступивших
            </span>
            <span className="flex items-center gap-1.5">
              <CheckCircle className="w-4 h-4 text-green-300" /> 3 курс МГСУ
            </span>
          </motion.div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm max-w-lg mx-auto">
              Каждый год сотни абитуриентов теряют бюджетные места из-за элементарных ошибок, о которых никто не предупредил.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-background/60 text-sm mb-6 max-w-md mx-auto">
              3 490 ₽ за полный разбор поступления. Это дешевле, чем год на платном из-за потерянного бюджетного места.
            </p>
            <a
              href="#final"
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-primary-foreground/75 text-sm mb-8 max-w-md mx-auto">
              Места на бюджете ограничены. Запишитесь сейчас — и я расскажу всё, что не пишут в брошюрах.
            </p>
            <ContactForm />
